...
rep_inc_winner <- rep_wl$winner_avg[[2]]
rep_inc_loser <- rep_wl$winner_avg[[1]]
...
rep_ninc_winner <- rep_wl$winner_avg[[2]]
rep_ninc_loser <- rep_wl$winner_avg[[1]]
...
dem_inc_winner <- dem_wl$winner_avg[[2]]
dem_inc_loser <- dem_wl$winner_avg[[1]]
