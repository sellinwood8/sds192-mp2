...
This data graphic examines the distribution of campaign funding between winners and losers of congressional elections in 2012. Additionally, it also shows how this distribution changes by both party affiliation and the state in which the election occurred. This provides insight into the impact that campaign finance has on the outcome of an election. We can see that among Republican candidates, those who lost the election received more funding on average than those who won. Contrastingly; among Democrats, those who won the election received much more funding than those who lost. This suggests that the Republican party is not as unified, as refelcted by their propensity to encourage donations to candidates who have a lower chance of winning. This could also suggest that money invested into Republican candidiates provides a lower return on investment as there is a greater likelihood that the candidate who receives the most donations will win the election. 
